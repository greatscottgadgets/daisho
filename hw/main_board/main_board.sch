...
Wire Wire Line
	9700 2200 9700 3200
$Sheet
S 4700 2500 1900 2000
U 5129C23F
F0 "fpga_configuration" 60
F1 "fpga_configuration.sch" 60
F2 "FPGA_TMS" I L 4700 3100 60 
F3 "FPGA_TCK" I L 4700 2800 60 
F4 "FPGA_TDI" I L 4700 2900 60 
F5 "FPGA_NSTATUS" B L 4700 2600 60 
F6 "SPI_MOSI" I L 4700 3500 60 
F7 "I2C_SDA" B R 6600 2700 60 
F8 "I2C_SCL" O R 6600 2600 60 
F9 "ULPI_DATA[7..0]" B R 6600 3100 60 
F10 "ULPI_NXT" I R 6600 3300 60 
F11 "ULPI_DIR" I R 6600 3200 60 
F12 "ULPI_STP" O R 6600 3400 60 
F13 "ULPI_CLK" I R 6600 3000 60 
F14 "PIPE_TX_ELECIDLE" O R 6600 3900 60 
F15 "PIPE_PHY_RESETN" O R 6600 3700 60 
F16 "PIPE_TX_DETRX_LPBK" O R 6600 3800 60 
F17 "PIPE_OUT_ENABLE" O R 6600 3600 60 
F18 "PIPE_TX_ONESZEROS" O R 6600 4100 60 
F19 "PIPE_TX_MARGIN[2..0]" O R 6600 4200 60 
F20 "PIPE_TX_SWING" O R 6600 4300 60 
F21 "PIPE_RATE" O R 6600 4400 60 
F22 "SPI_SS" I L 4700 3300 60 
F23 "SPI_SCK" I L 4700 3400 60 
F24 "FPGA_TDO_V1P8" O L 4700 3000 60 
F25 "SPI_MISO_V1P8" O L 4700 3600 60 
$EndSheet
$Comp
L HOLE H8
U 1 1 516AFA7B
...
$EndSheet
$Sheet
S 5400 4800 1200 2100
U 5129BCC5
F0 "fpga_usb0" 60
F1 "fpga_usb0.sch" 60
F2 "PIPE_RESETN" O R 6600 5800 60 
F3 "PIPE_PWRPRESENT" I R 6600 6300 60 
F4 "PIPE_PHY_STATUS" B R 6600 6200 60 
F5 "PIPE_POWERDOWN[1..0]" O R 6600 6100 60 
F6 "PIPE_RX_ELECIDLE" B R 6600 5900 60 
F7 "PIPE_RX_STATUS[2..0]" I R 6600 6000 60 
F8 "PIPE_RX_VALID" I R 6600 5600 60 
F9 "PIPE_RX_DATAK[1..0]" I R 6600 5500 60 
F10 "PIPE_RX_DATA[15..0]" I R 6600 5400 60 
F11 "PIPE_PCLK" I R 6600 5300 60 
F12 "PIPE_TX_DATAK[1..0]" O R 6600 5100 60 
F13 "PIPE_TX_DATA[15..0]" O R 6600 5000 60 
F14 "PIPE_TX_CLK" O R 6600 4900 60 
F15 "PIPE_ELAS_BUF_MODE" O R 6600 6800 60 
F16 "PIPE_RX_TERMINATION" O R 6600 6700 60 
F17 "PIPE_RX_POLARITY" O R 6600 6600 60 
F18 "PIPE_TX_DEEMPH[1..0]" O R 6600 6500 60 
$EndSheet
$Sheet
S 7000 2900 1000 4000
U 5109FB2D
F0 "usb0_interfaces" 60
F1 "usb0_interfaces.sch" 60
F2 "RX_VALID" O L 7000 5600 60 
F3 "RX_DATAK[1..0]" O L 7000 5500 60 
F4 "RX_DATA[15..0]" O L 7000 5400 60 
F5 "PCLK" O L 7000 5300 60 
F6 "TX_CLK" I L 7000 4900 60 
F7 "TX_DATA[15..0]" I L 7000 5000 60 
F8 "TX_DATAK[1..0]" I L 7000 5100 60 
F9 "ULPI_NXT" O L 7000 3300 60 
F10 "ULPI_DIR" O L 7000 3200 60 
F11 "ULPI_CLK" O L 7000 3000 60 
F12 "ULPI_STP" I L 7000 3400 60 
F13 "ULPI_DATA[7..0]" B L 7000 3100 60 
F14 "RESETN" I L 7000 5800 60 
F15 "OUT_ENABLE" I L 7000 3600 60 
F16 "PHY_RESETN" I L 7000 3700 60 
F17 "TX_DETRX_LPBK" I L 7000 3800 60 
F18 "TX_ELECIDLE" I L 7000 3900 60 
F19 "RX_ELECIDLE" B L 7000 5900 60 
F20 "RX_STATUS[2..0]" O L 7000 6000 60 
F21 "POWER_DOWN[1..0]" I L 7000 6100 60 
F22 "PHY_STATUS" B L 7000 6200 60 
F23 "PWRPRESENT" O L 7000 6300 60 
F24 "TX_ONESZEROS" I L 7000 4100 60 
F25 "TX_DEEMPH[1..0]" I L 7000 6500 60 
F26 "TX_MARGIN[2..0]" I L 7000 4200 60 
F27 "TX_SWING" I L 7000 4300 60 
F28 "RX_POLARITY" I L 7000 6600 60 
F29 "RX_TERMINATION" I L 7000 6700 60 
F30 "RATE" I L 7000 4400 60 
F31 "ELAS_BUF_MODE" I L 7000 6800 60 
$EndSheet
$Sheet
